...
if(empty($_SESSION['captcha'] ) ||
	...
	if(empty($errors))
	{
		...
		$sql = "INSERT INTO $tablename (name,login, phone, item, start_day, start_time, end_day, end_time, canceled,odbior)
			VALUES ('$name','$login','$phone', '$item', $start_day, $start_time, $end_day, $end_time, 0,'nie')";
		if (mysqli_query($conn, $sql)) {
		    echo "<h3>Rezerwacja się powiodła.</h3>";
		} else {
